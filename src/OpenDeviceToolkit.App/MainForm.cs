...
public sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        var subtitle = new Label { Text = "Device reconnaissance workbench • read-only alpha", AutoSize = true, Location = new Point(27, 58) };
        ...
        _status.AutoSize = false; _status.Location = new Point(24, 345); _status.Size = new Size(440, 250); _status.Text = "Status\r\n------\r\nReady.\r\n\r\nWorkspace:\r\n" + _workspace.Root; _status.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left;
